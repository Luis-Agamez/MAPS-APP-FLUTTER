...
import 'package:mpas_app_bloc/helpers/show_loading_message.dart';
              ...
              child: FadeInUp(
                ...
                child: MaterialButton(
                  ...
                  onPressed: () async {
                    ...
                    await mapBloc.drawRotePolyline(destination);
  ...
  Widget build(BuildContext context) {
    return FadeInLeft(
      ...
      child: CircleAvatar(
        ...
        child: IconButton(
          onPressed: () {
            //TODO : Cancel the marker
            BlocProvider.of<SearchBloc>(context)
                .add(OnDesactiveManualMarkerEvent());
          },
          icon: const Icon(
